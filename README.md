...
Each iDaaS-Connect component/module has a consistent approach within it, this approach consists of having processes 
and converters. Within each component/module each process and/or converters are defined and able to invoked by settings.
Each of these process and/or converters follows the same pattern for consistent, extensible and scalable needs. Currently, 
there are two converters: CCDA to FHIR and HL7v2 to FHIR. Currently, there are numerous defined processes:
cloud, datatier, deidentification, empi, heda (Healthcare Event Driven Architecture), sdoh and terminologies. 
...
Here is a high level component based visual:<br/><br/>
