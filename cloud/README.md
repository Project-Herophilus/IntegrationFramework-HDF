# iDAAS-Connect-Cloud
iDAAS-Connect-Cloud specifically is ONLY intended to deal with enabling
iDAAS to all sorts of public cloud connectivity. The vendors currently supported are AWS, Azure and GCP.
...
and then there are specific submodule requirements. For general pre-requisites can be found 
[here](https://github.com/Project-Herophilus/iDaaS-Connect), near the bottom in the Platform General Pre-Requisites
section.
