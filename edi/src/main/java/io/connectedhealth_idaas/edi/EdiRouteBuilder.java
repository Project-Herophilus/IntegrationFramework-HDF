...
public class EdiRouteBuilder extends RouteBuilder {
  ...
  public void configure() throws Exception {
    ...
    onException(Exception.class)
            ...
            .to("micrometer:counter:ediExceptionHandled");
    ...
    rest("/edi270")
            ...
            .log("${exchangeId} fully processed")
            .to("micrometer:counter:edi270ProcessedEvents")
    ...
    rest("/edi276")
            ...
            .log("${exchangeId} fully processed")
            .to("micrometer:counter:edi276ProcessedEvents")
    ...
    rest("/edi278")
            ...
            .log("${exchangeId} fully processed")
            .to("micrometer:counter:edi278ProcessedEvents")
   ...
   .endRest();
    ...
    rest("/edi834")
            ...
            .log("${exchangeId} fully processed")
            .to("micrometer:counter:edi834ProcessedEvents")
    ...
    rest("/edi835")
            ...
            .log("${exchangeId} fully processed")
            .to("micrometer:counter:edi835ProcessedEvents")
    ...
    rest("/edi837")
            ...
            .log("${exchangeId} fully processed")
            .to("micrometer:counter:edi837ProcessedEvents")
