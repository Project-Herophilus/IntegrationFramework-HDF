 ...
 public class FhirRouteBuilder extends RouteBuilder {
     ...
     public void configure() throws Exception {
         ...
         from("direct:fhirmessaging")
                 ...
                 .to("micrometer:counter:fhir_Inbd_Transactions")
                 // testing for null
                 ...
                 //simple("${header.baz} != null")
                    ...
                    .choice().when(simple("{{idaas.process.FHIR}}"))
                        .to("micrometer:counter:fhirServer_Rest_Inbd_Transactions")
         ...
         rest("/fhirendpoint")
                 ...
                 .to("micrometer:counter:fhirendpoint_Rest_Inbd_Transactions")
