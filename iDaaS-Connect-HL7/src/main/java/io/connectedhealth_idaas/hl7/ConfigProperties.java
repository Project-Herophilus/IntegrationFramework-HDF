...
public class ConfigProperties {
    ...
    public String getFhirConversionTopic() { return fhirConversionTopic;}
    public void setFhirConversionTopic(String fhirConversionTopic) { this.fhirConversionTopic = fhirConversionTopic; }
